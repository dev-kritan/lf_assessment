...
export const config = {
  ...
  db: {
    ...
    filename: process.env.DB_FILENAME || path.resolve(__dirname, '../../database/event_planner.sqlite'),
  },
  ...
  smtp: {
    ...
    from: process.env.SMTP_FROM || `"${process.env.APP_NAME || 'EventHub'}" <noreply@eventhub.local>`,
  },
};
