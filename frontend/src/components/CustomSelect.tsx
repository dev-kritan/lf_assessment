  ...
  return (
    <div className={`relative inline-block ${className}`} ref={containerRef}>
      ...
      {isOpen && (
        <div
          role="listbox"
          className={`absolute left-0 top-full mt-2 z-50 min-w-full w-max max-w-[280px] p-1.5 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200/90 dark:border-slate-800/90 shadow-2xl animate-fade-in ${menuClassName}`}
        >
